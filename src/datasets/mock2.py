...
def load_data(
    ...
    # [2/3] Weaker feature (less separable)
    sig_x5 = rs.normal(-1, 2, (n_samples_per_class, 1))
    bkg_x5 = rs.normal(1, 2, (n_samples_per_class, 1))

    # [3/3] Stronger feature (more separable)
    sig_x6 = rs.normal(-3, 2, (n_samples_per_class, 1))
    bkg_x6 = rs.normal(3, 2, (n_samples_per_class, 1))

    # Combine all the data
    sig_x = np.concatenate([sig_x1, sig_x5, sig_x6], axis=1)
    bkg_x = np.concatenate([bkg_x1, bkg_x5, bkg_x6], axis=1)
