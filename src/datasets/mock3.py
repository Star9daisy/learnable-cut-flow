...
def load_data(
    ...
    # [2/3] Redundant feature 1
    sig_x7 = rs.normal(-5, 2, (n_samples_per_class, 1))
    bkg_x7 = rs.normal(-5, 2, (n_samples_per_class, 1))

    # Redundant feature 2
    sig_x8 = rs.normal(5, 2, (n_samples_per_class, 1))
    bkg_x8 = rs.normal(5, 2, (n_samples_per_class, 1))

    # Combine all the data
    sig_x = np.concatenate([sig_x1, sig_x7, sig_x8], axis=1)
    bkg_x = np.concatenate([bkg_x1, bkg_x7, bkg_x8], axis=1)
